            ...
            <tbody className="divide-y text-sm">
              {Array.from({ length: 5 }).map((_, i) => (
                <tr key={i} className="hover:bg-gray-50">
                  ...
                  <td className="py-4 px-6 text-gray-600">user{i + 1}@example.com</td>
                  <td className="py-4 px-6 text-gray-600">0912345{i}89</td>
                  <td className="py-4 px-6">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                      ${i % 2 === 0 ? 'bg-blue-50 text-blue-700' : 'bg-green-50 text-green-700'}`}>
                      {i % 2 === 0 ? 'Người dùng' : 'Bác sĩ'}
                    </span>
                  </td>
                  <td className="py-4 px-6">
        ...
        <div className="p-4 border-t">
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-600">
              Hiển thị 1-5 trong số 100 người dùng
            </p>
            <div className="flex items-center gap-2">
