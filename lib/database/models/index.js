...
const AiConsultation = require("./AiConsultation")(sequelize, Sequelize.DataTypes);
...
User.hasMany(AiConsultation, { foreignKey: "userId", as: "aiConsultations" });
...
// AiConsultation associations
AiConsultation.belongsTo(User, { foreignKey: "userId", as: "user" });
